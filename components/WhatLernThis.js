...
export default function WhatLernThis({datas}) {
    ...
    return (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4  gap-8 mb-8 ">
                {
                    datas.map((data) =>
                        <div key={data.id} className=" flex gap-6 items-center z-0 text-center hover:scale-x-110 hover:scale-y-105  duration-200 ease-out rounded-2xl bg-gray-900 hover:bg-indigo-800 px-8 py-6">
